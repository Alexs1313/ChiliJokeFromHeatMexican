import type {RatePhrase} from '../types';

/** “Good” verdict lines for Rate My Jokes. */
export const rateGoodPhrases: RatePhrase[] =
  [
    {
      title: '¡CALIENTE! 🔥',
...
export const rateBadPhrases: RatePhrase[] =
  [
    {
      title: '¡AY, NO! 🙈',
...
export const rateLoaderHtml = `  <!DOCTYPE html>
    <html>
      <head>
