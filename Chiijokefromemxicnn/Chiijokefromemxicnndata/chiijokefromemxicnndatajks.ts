export type ChiijokefromemxicnnJokeCategoryKey = 'angry' | 'smart' | 'romantic';

export type ChiijokefromemxicnnJokeCategory = {
  key: ChiijokefromemxicnnJokeCategoryKey;
  icon: string;
  title: string;
  subtitle: string;
  description: string;
...
export const chiijokefromemxicnnJokeCategories: ChiijokefromemxicnnJokeCategory[] =
  [
    {
      key: 'angry',
      icon: '😤',
