export type ChiijokefromemxicnnRatePhrase = {
  title: string;
  body: string;
  score: number;
};
...
export const chiijokefromemxicnnRateGoodPhrases: ChiijokefromemxicnnRatePhrase[] =
  [
    {
      title: '¡CALIENTE! 🔥',
...
export const chiijokefromemxicnnRateBadPhrases: ChiijokefromemxicnnRatePhrase[] =
  [
    {
      title: '¡AY, NO! 🙈',
...
export const chiijokefromemxicnnRateLoaderHtml = `  <!DOCTYPE html>
    <html>
      <head>
